 ...
 */
async function deductStock(prisma, itemId, quantityBase, invoiceId = null, notes = '') {
  const iId = Number(itemId);
  if (isNaN(iId)) {
  ...
  // Execute inside transaction or atomic operation to calculate correct balanceAfter
